...
_mongoose["default"].set('strictQuery', false); // true depreca queries, false es mas rapido
...
function _connectDB() {
  _connectDB = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return _context.a(2, cached.conn);
        case 1:
          if (!cached.promise) {
            console.log('[DB] Conectando a Mongo...');
            cached.promise = _mongoose["default"].connect(MONGODB_URI, {
              maxPoolSize: 10,
              // Koyeb free: max 10 conexiones
              minPoolSize: 2,
              // Mantiene 2 vivas
        ...
        case 4:
          ...
          _t = _context.v;
          cached.promise = null;
          console.error('[DB] Error de conexion', _t);
          throw _t;
        case 5:
          return _context.a(2, cached.conn);
      }
