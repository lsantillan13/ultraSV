...
var _ttsService = require("../../services/tts.service.js");
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          Post = getPostModel();
          q = _mongoose["default"].Types.ObjectId.isValid(req.params.slug) ? {
            _id: req.params.slug
          } : {
            Entry_Slug: req.params.slug
          };
          _context.n = 1;
          return Post.findOne(q).select('Entry_Title Entry_Body_Plain Entry_Body_Resume_Plain Entry_Resume Entry_Slug ttsAudioUrl readingTime ttsGeneratedAt').lean();
        case 1:
          post = _context.v;
          if (post) {
            _context.n = 2;
        ...
        case 2:
          res.json({
            data: {
              ...
              audioUrl: post.ttsAudioUrl || null,
              // ej: /public/audio/6aa470c2ce03e441d9cd18b8.mp3
...
router.post('/:slug/generate', /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return (0, _ttsService.generateTTS)(req.params.slug);
        case 1:
          result = _context2.v;
          res.json({
            ok: true,
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.error('[TTS GENERATE]', _t2);
          res.status(500).json({
            ok: false,
            message: _t2.message
          });
