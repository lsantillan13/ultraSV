...
router.post('/vox-rewrite', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$body, texto_original, fuente1, modo, prompt, r, data, _e$response, _e$response2, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          prompt = "Sos editor de VoxDiario Neuqu\xE9n. Modo: ".concat(modo, " Fuente: ").concat(fuente1, ". Reescrib\xED 100% original. Devolv\xE9 SOLO JSON: { \"Entry_Title\": \"\", \"Entry_Bajada\": \"\", \"Entry_Content\": \"\", \"Entry_Slug\": \"\", \"Entry_Category\": \"general\" } Texto: ").concat(texto_original);
          _context.p = 2;
          _context.n = 3;
        ...
        case 4:
          _context.p = 4;
          _t = _context.v;
          console.log("ERROR GROQ COMPLETO:", ((_e$response = _t.response) === null || _e$response === void 0 ? void 0 : _e$response.data) || _t.message);
          res.status(500).json({
            error: "Groq falló",
            detalle: ((_e$response2 = _t.response) === null || _e$response2 === void 0 ? void 0 : _e$response2.data) || _t.message,
