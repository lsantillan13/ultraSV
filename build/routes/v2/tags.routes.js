...
router.get('/:tag', cache, /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var tag, limit, page, Post, posts, total, _t2;
      ...
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          return Post.find({
            ...
            createdAt: -1
          }).skip((page - 1) * limit).limit(limit).select('Entry_Title Entry_Slug Entry_Featured_Image Entry_Category Entry_Tags createdAt Entry_Body_Resume_Plain readingTime').lean();
        case 1:
          posts = _context2.v;
          _context2.n = 2;
