...
function _run() {
  _run = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var collections, _i, _collections, colName, col, indexes, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          collections = ['entries', 'posts']; // por si tenés las dos
        ...
        case 2:
          ...
          colName = _collections[_i];
          _context.p = 3;
          col = _mongoose["default"].connection.db.collection(colName);
          _context.n = 4;
          return col.indexes();
        case 4:
          indexes = _context.v;
          console.log("\n> \xCDndices de ".concat(colName, ":"), indexes.map(function (i) {
            return i.name;
          }));
          ...
          console.log("  Limpiando \xEDndices de ".concat(colName, "..."));
          _context.n = 5;
          return col.dropIndexes();
        case 5:
          console.log("  OK - \xEDndices borrados de ".concat(colName));
          _context.n = 7;
          break;
        case 6:
          _context.p = 6;
          _t = _context.v;
          console.log("  ".concat(colName, " no existe o ya est\xE1 limpio:"), _t.message);
        case 7:
          _i++;
          _context.n = 2;
          break;
